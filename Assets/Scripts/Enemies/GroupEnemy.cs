...
public class GroupEnemy : Enemy
{
    ...
    {
        main.SpawnGroup(EnemyType.GROUP_BIG, enemy.transform.position, enemy.transform.rotation, difficulty, path);
        main.SpawnGroup(EnemyType.GROUP_SMALL, enemy.transform.position, enemy.transform.rotation, difficulty, path);
        main.SpawnGroup(EnemyType.GROUP_SMALL, enemy.transform.position, enemy.transform.rotation, difficulty, path);
